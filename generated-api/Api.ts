...
export interface UserProjectUpdateDto {
  /** @example "Back-End" */
  role?: string;
  /** @example "Brief description" */
  description?: string;
...
export interface UserSkillUpdateDto {
  /** @example "Description" */
  description?: string;
  /** @format date-time */
  learnedAt?: string;
...
export interface UserProjectSkillCreateDto {
  /** @example 1 */
...
export interface UserProjectSkillUpdateDto {
  /** @example "Description" */
  description?: string;
}
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  userProfile = {
     ...
     * @secure
     */
    userProfileControllerUpdateOne: (data: UserProfileUpdateDto, params: RequestParams = {}) =>
      this.request<any, UserResponseDto>({
  ...
  projects = {
     ...
     * @secure
     */
    projectControllerUpdateOne: (id: number, data: ProjectUpdateDto, params: RequestParams = {}) =>
  ...
  userProject = {
     ...
     * @secure
     */
    userProjectControllerAddOne: (data: ProjectCreateDto, params: RequestParams = {}) =>
     ...
     * @secure
     */
    userProjectControllerUpdateOne: (id: number, data: UserProjectUpdateDto, params: RequestParams = {}) =>
      this.request<UserProjectUpdateDto, any>({
        path: `/userProject/${id}`,
        method: "PUT",
        body: data,
        secure: true,
  ...
  userSkill = {
     ...
     * @secure
     */
    userSkillControllerUpdateOne: (id: number, data: UserSkillUpdateDto, params: RequestParams = {}) =>
  ...
  userProjectSkill = {
     ...
     * @secure
     */
    userProjectSkillControllerAddOne: (data: UserProjectSkillCreateDto, params: RequestParams = {}) =>
      this.request<void, any>({
     ...
     * @secure
     */
    userProjectSkillControllerUpdateOne: (id: number, data: UserProjectSkillUpdateDto, params: RequestParams = {}) =>
      this.request<void, any>({
